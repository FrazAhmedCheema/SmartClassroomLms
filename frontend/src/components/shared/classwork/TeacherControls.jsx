...
//   // Close create menu when clicked outside
//   useEffect(() => {
...
//                   className="w-full px-4 py-2 text-left text-sm text-gray-700 bg-gray-100 hover:bg-gray-50 flex items-center gap-2"
//                 >
...
//           {expandedTopic === 'all'
//             ? 'All Topics'
//             : topics?.find((t) => t._id === expandedTopic)?.name ||
//               'All Topics'}
//           <ChevronDown
//             size={14}
//             className={`transition-transform ${
//               topicsMenuOpen ? 'rotate-180' : ''
//             }`}
//           />
//         </button>
//         <AnimatePresence>
...
//                     {type === 'material' ? 'Lecture Material' : type}
//                   </span>
//                 </button>
//               ))}
