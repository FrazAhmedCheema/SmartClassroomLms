...
const AddEntityModal = ({ isOpen, onClose, onSubmit, entityType }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-2xl transform transition-all my-8 w-full max-w-md">
        <div className="bg-gray-50 px-8 py-4 rounded-t-xl border-b-2 border-gray-100">
          <h2 className="text-2xl font-bold text-gray-800">Add New {entityType}</h2>
        </div>
        
        <form onSubmit={handleSubmit} className="p-8 overflow-y-auto max-h-[calc(100vh-200px)]">
