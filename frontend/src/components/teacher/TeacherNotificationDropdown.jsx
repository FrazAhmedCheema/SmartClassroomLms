...
const TeacherNotificationDropdown = () => {
  ...
  const handleToggleDropdown = () => {
    ...
    if (!isOpen) {
      ...
      console.log('[DEBUG] Opening teacher notification dropdown, fetching notifications...');
      dispatch(fetchTeacherNotifications())
        .then(action => {
          console.log('[DEBUG] Teacher notification fetch result:', action);
          if (action.payload && action.payload.notifications) {
            console.log(`[DEBUG] Received ${action.payload.notifications.length} teacher notifications`);
            
            // Check specifically for discussion notifications
            const discussionNotifs = action.payload.notifications.filter(n => n.type === 'discussion');
          ...
          >
            ...
            <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-800">Teacher Notifications</h3>
